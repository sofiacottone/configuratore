...
--
-- Host: 127.0.0.1    Database: configuratore
-- ------------------------------------------------------
...
CREATE TABLE `customers` (
  ...
  `tax_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `vat_number` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `order_items` (
  ...
  `sites_number` tinyint NOT NULL,
  `users_number` tinyint NOT NULL,
  `annual_waste` tinyint NOT NULL,
...
-- Dump completed on 2024-10-14  2:17:12
